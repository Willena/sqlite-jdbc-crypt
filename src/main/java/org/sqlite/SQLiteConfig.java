...
public class SQLiteConfig {
    ...
    public enum Pragma {
        ...
        REKEY(
                "rekey",
                "Used to encrypt an existing unencrypted database, change the encryption key of an existing encrypted database, remove encryption from an existing encrypted database",
                null),
        CIPHER(
                "cipher",
                "Allows to select the cipher to be used for encrypting the database",
                null),
        HMAC_CHECK(
                "hmac_check",
                "Sets a boolean flag whether the HMAC should be validated on read operations for encryption schemes using HMACs",
                null),
        MC_LEGACY_WAL(
                "mc_legacy_wal",
                "Sets a boolean flag whether the legacy mode for the WAL journal encryption should be used",
                null),
        ...
        FAST_KDF_ITER(
                "fast_kdf_iter",
                "Allows to increase or decrease the number of iterations used",
                null),
        HMAC_USE("hmac_use", "Allows to enable or disable the use of per-page HMACs", null),
        HMAC_PGNO(
                "hmac_pgno",
                "Allows to modify in which endianess the page number should be used",
                null),
        HMAC_SALT_MASK(
                "hmac_salt_mask", "Allows to modify the mask byte when calculating HMAC", null),
        KDF_ALGORITHM(
                "kdf_algorithm", "Allows to modify hash algorithm used for key derivation", null),
        HMAC_ALGORITHM(
                "hmac_algorithm",
                "Allows to modify hash algorithm used for HMAC calculation",
                null),
    ...
    public enum AutoVacuum implements PragmaValue {
        NONE,
        FULL,
        INCREMENTAL;
    ...
    public enum Cache implements PragmaValue {
        PRIVATE,
        SHARED;
